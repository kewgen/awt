...
public class GLSurfaceView_ extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void setRenderer(Renderer renderer) {
        ...
        Log.w("****************", renderer != null ? renderer.toString() : "null");
     ...
     * this interface, and then call {@link GLSurfaceView_#setRenderer} to
     ...
     * use the {@link GLSurfaceView_#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     * {@link GLSurfaceView_#setEGLContextFactory(EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLSurfaceView_#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLSurfaceView_#setEGLConfigChooser(EGLConfigChooser)}
     */
            ...
            try {
                ...
                while (true) {
                    ...
                    if (createEglSurface) {
                        ...
                        if (mRenderer == null) Log.w("GLThread", "mRenderer == null");
                        if (mEglHelper == null) Log.w("GLThread", "mEglHelper == null");
                        if (mEglHelper.mEglConfig == null) Log.w("GLThread", "mEglHelper.mEglConfig == null");
        ...
        public void onWindowResize(int w, int h) {
            synchronized (sGLThreadManager) {
                ...
                while (! mExited && !mPaused && !mRenderComplete ) {
                    if (LOG_SURFACE) {
                        Log.i("Main thread", "onWindowResize waiting for render complete.(my)");
                    }
                    try {
                        sGLThreadManager.wait();
    ...
    public void setPreserveEGLContextOnPause(boolean b) {
        //super.setPreserveEGLContextOnPause(b);
    }
