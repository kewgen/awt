...
public abstract class MIDlet extends JFrame implements HTTPCounter {
    ...
    public void setContentView(com.geargames.platform.packer.Canvas canvas) {
    }//android затычка

    public void runOnUiThread(Runnable runnable) {
    }//android затычка

    public com.geargames.platform.packer.Image getSplash() {
        return null;
    }
    ...
    public com.geargames.platform.packer.Image getImageOfSplash() {
        return null;
    }

    public void setDisplay(com.geargames.platform.packer.Canvas canvas) {
    }
    ...
    public String saveScreenShot(com.geargames.platform.packer.Canvas canvas, String pfp_ss) {
